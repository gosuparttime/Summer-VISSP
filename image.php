			...
			<div id="content" class="clearfix row-fluid">
				...
				<div id="main" class="span8 clearfix" role="main">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
						...
						<header> 
							...
							<p class="meta"><?php _e("Posted", "summertheme"); ?> <time datetime="<?php echo the_time('Y-m-j'); ?>" pubdate><?php the_date(); ?></time> <?php _e("by", "summertheme"); ?> <?php the_author_posts_link(); ?>.</p>
					...
					<article id="post-not-found">
					    <header>
					    	<h1><?php _e("Not Found", "summertheme"); ?></h1>
					    </header>
					    <section class="post_content">
					    	<p><?php _e("Sorry, but the requested resource was not found on this site.", "summertheme"); ?></p>
					    </section>
					    <footer>
					    </footer>
					</article>
				...
				<div id="sidebar1" class="span4 fluid-sidebar sidebar" role="complementary">
					...
					<div class="well">
						...
						<h3><?php _e("Image metadata","summertheme"); ?></h3>
					...
					// Start to display EXIF and IPTC data of digital photograph
					       if ( $imgmeta['image_meta']['created_timestamp'] ) { 
					           echo __("Date Taken","summertheme") . ": " . date("d-M-Y H:i:s", $imgmeta['image_meta']['created_timestamp'])."<br />"; }
					       if ( $imgmeta['image_meta']['copyright'] ) { 
					           echo __("Copyright","summertheme") . ": " . $imgmeta['image_meta']['copyright']."<br />"; }
					       if ( $imgmeta['image_meta']['credit'] ) { 
					           echo __("Credit","summertheme") . ": " . $imgmeta['image_meta']['credit']."<br />"; }
					       if ( $imgmeta['image_meta']['title'] ) { 
					           echo __("Title","summertheme") . ": " . $imgmeta['image_meta']['title']."<br />"; }
					       if ( $imgmeta['image_meta']['caption'] ) { 
					           echo __("Caption","summertheme") . ": " . $imgmeta['image_meta']['caption']."<br />"; }
					       if ( $imgmeta['image_meta']['camera'] ) { 
					           echo __("Camera","summertheme") . ": " . $imgmeta['image_meta']['camera']."<br />"; }
					       if ( $imgmeta['image_meta']['focal_length'] ) { 
					           echo __("Focal Length","summertheme") . ": " . $imgmeta['image_meta']['focal_length']."mm<br />"; }
					       if ( $imgmeta['image_meta']['aperture'] ) { 
					           echo __("Aperture","summertheme") . ": f/" . $imgmeta['image_meta']['aperture']."<br />"; }
					       if ( $imgmeta['image_meta']['iso'] ) { 
					           echo __("ISO","summertheme") . ": " . $imgmeta['image_meta']['iso']."<br />"; }
					       if ( $pshutter ) { 
					           echo __("Shutter Speed","summertheme") . ": " . $pshutter . "<br />"; }
					   ?>
					</div>
